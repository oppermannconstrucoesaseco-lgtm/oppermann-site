...
const servicePages = {
  "/drywall-itapema": {
    ...
    estudo: {
      url: "/estudo-drywall-alvenaria",
      label: "Drywall × Alvenaria: estudo técnico de viabilidade"
    },
    description:
...
export function ServiceSeoPage({ page }) {
  ...
  return (
    <main className="service-seo-page">
      ...
      {page.estudo && (
        <section className="service-seo-estudo">
          <div className="container service-seo-estudo-panel">
            <div className="service-seo-estudo-icon" aria-hidden="true">
            ...
            <div className="service-seo-estudo-text">
              <strong>Material técnico disponível</strong>
              <span>{page.estudo.label}</span>
            </div>
            <a className="btn btn-secondary service-seo-estudo-btn" href={page.estudo.url}>
              Ver estudo completo
            </a>
          </div>
        </section>
